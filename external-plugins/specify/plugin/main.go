...
import (
	...
	"kubevirt.io/project-infra/external-plugins/specify/plugin/handler"
	...
	"kubevirt.io/project-infra/external-plugins/specify/plugin/server"
)
...
func main() {
	...
	logger.Println("Specify plugin server was gracefully shut down")
}

func helpProvider(_ []config.OrgRepo) (*pluginhelp.PluginHelp, error) {
	pluginHelp := &pluginhelp.PluginHelp{
		Description: `The Specify plugin is used to trigger phase 2 jobs when PR is ready for merging.`,
	}
